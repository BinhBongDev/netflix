        ...
        <div className='max-w-[450px] h-[600px] mx-auto bg-black/75 text-white'>
          <div className='max-w-[320px] mx-auto py-16'>
            ...
            <form className='flex w-full flex-col py-4'>
              <input className='p-3 my-2 rounded bg-gray-700' type={'email'} placeholder={"Enter your Email"} autoComplete="email" />
              <input className='p-3 my-2 rounded bg-gray-700' type={'password'} placeholder="Enter your password" autoComplete='current-password' />
